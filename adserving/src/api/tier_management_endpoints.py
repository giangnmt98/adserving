...
@router.post("/tier/manual-assignment")
...
@router.delete("/tier/manual-assignment/{model_name}")
...
@router.get("/tier/manual-assignment/{model_name}")
...
@router.get("/tier/business-critical-models")
...
@router.post("/tier/business-critical-pattern")
...
@router.delete("/tier/business-critical-pattern")
