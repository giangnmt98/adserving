...
class ModelMonitoringService:
    ...
    def __init__(
        ...
        self.update_interval = (
            config.monitoring.update_interval or update_interval
        )
        if config.mlflow.production_check_interval:
            self.production_check_interval = (
                config.mlflow.production_check_interval
            )
        else:
        ...
        while not self._stop_monitoring.wait(self.update_interval):
            try:
                ...
                if (
                    ...
                    self.logger.debug("Checking for production model changes...")
